'''
https://github.com/google-research/google-research/blob/master/sequential_attention/sequential_attention/experiments/models/mlp.py
'''
...
class MLPModel(tf.keras.Model):
  ...
  def __init__(
    ...
    self.layer_sequence = layer_sequence or [67, 32]  # Default values # added 
    print(f"self.layer_sequence  is {self.layer_sequence }")
    ...
    mlp_sequence = [
        ...
        for dim in self.layer_sequence
    ]
