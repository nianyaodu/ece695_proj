...
https://github.com/lasso-net/lassonet/blob/f2bf7d21274b21519dddc52e759a137b1aa868c4/lassonet/plot.py
it is modified so that the output plot can be saved. 
'''
import matplotlib.pyplot as plt

from lassonet.interfaces import BaseLassoNetCV
from lassonet.utils import confidence_interval, eval_on_path


def plot_path(model, X_test, y_test, *, score_function=None, save_path=None):
    """
    ...
    save_path : string where the plot should be saved
    """
